...
{
	public class WalletToSpendingProcessor : BaseLogicStepProcessor
	{
		private long _amount;

		public static WalletToSpendingProcessor create(long _amount)
		{
			WalletToSpendingProcessor processor = new WalletToSpendingProcessor();
			processor.init(_amount);
			return processor;
		}
		...
		{
			MapPacket req = Network.createReq(CSMessageID.Wallet.WalletToSpendingReq);
