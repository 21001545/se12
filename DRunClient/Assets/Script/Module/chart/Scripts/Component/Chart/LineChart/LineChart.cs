...
namespace AwesomeCharts {
    ...
    public class LineChart : AxisBaseChart<LineData> {
        ...
        [SerializeField]
        private int valueFocusIndex;
        [SerializeField]
        private bool drawValueFocusLine = true;
        ...
        private UILineChartValueFocusRenderer valueFocusRenderer;
        ...
        protected override void Start()
        {
            ...
            if(drawValueFocusLine)
            {
                var newValueFocusRenderer = viewCreator.CreateBaseGameObject("ValueFocusRenderer", transform, PivotValue.BOTTOM_LEFT);
                newValueFocusRenderer.GetComponent<RectTransform>().sizeDelta = GetSize();
                valueFocusRenderer = newValueFocusRenderer.AddComponent<UILineChartValueFocusRenderer>();
            }
        }
        ...
        protected override void OnDrawChartContent () {
            ...
            valueFocusRenderer?.Initialize(data.DataSets, valueFocusIndex, GetAxisBounds());
        }

        public void SetValueFocusIndex(int index)
        {
            valueFocusIndex = index;
        }
        ...
        private int DrawLine (UILineRenderer lineRenderer, LineDataSet dataSet, int dataSetIndex, int currentIndicatorPosition) {
            ...
            lineRenderer.Points = dataSet.UseBezier ? bezierPoints[dataSetIndex] :
                entriesPoints[dataSetIndex];
        ...
        private void UpdateValuePopup (LineEntryIdicator indicator) {
            ...
            currentValuePopup.SetText("" + indicator.entry.Value);
