...
namespace AwesomeCharts {
    ...
    public abstract class AxisBaseChart<T> : BaseChart<T> where T : AxisChartData {
        ...
        private void UpdateAxis () {
            ...
            if (GetVerticalAxisConfig().ShowConfig)
            {
                ...
                verticalAxisLabelRenderer.gameObject.SetActive(true);
            }
            else
            {
                verticalAxisLabelRenderer.gameObject.SetActive(false);
            }

            if (GetHorizontalAxisConfig().ShowConfig)
            {
                ...
                horizontalAxisLabelRenderer.gameObject.SetActive(true);
            }
            else
            {
                horizontalAxisLabelRenderer.gameObject.SetActive(false);
            }
        }
