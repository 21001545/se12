...
namespace AwesomeCharts {
    public class ViewCreator : Object {
        ...
        public GameObject CreateBaseGameObject (string name, Transform parent, Vector2 pivot) {
        ...
        public ChartValuePopupAbstract InstantiateChartPopup (Transform parent, ChartValuePopupAbstract popupPrefab) {
            ChartValuePopupAbstract popup = InstantiateWithPrefab (popupPrefab ??
                Resources.Load<ChartValuePopupAbstract> ("prefabs/ChartValuePopup"),
                parent);
