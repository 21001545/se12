...
namespace Festa.Client
{
    public class ResendCodeTimer : MonoBehaviour
    {
        ...
        public void turnOnTimer()
        {
            ...
            txt_resendCode.color = ColorChart.gray_500;
            img_underline.color = ColorChart.gray_500;
            img_underline.GetComponent<RectTransform>().sizeDelta = new Vector2(txt_resendCode.preferredWidth, 1f);
