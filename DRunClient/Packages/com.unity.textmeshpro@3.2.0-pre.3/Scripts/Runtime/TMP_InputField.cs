...
namespace TMPro
{
        ...
        IScrollHandler
    {
        ...
        /// </summary>
        [SerializeField]
        private bool m_HideSoftKeyboard = true;
        ...
        // 2022.09.14 이강희
        protected virtual GameObject createCaret()
        {
            ...
            go.transform.SetSiblingIndex(1);    // placeholder보다 아래로 가는 이슈 수정
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            //Debug.Log($"InPlaceEditing:[{InPlaceEditing()}]");
            ...
            //Debug.Log($"hadFocusBefore[{hadFocusBefore}] m_OnFocusSelectAll[{m_OnFocusSelectAll}]");
    ...
    //            Debug.Log($"insertionIndex[{insertionIndex}] insertionSide[{insertionSide}] shift[{shift}]");
    ...
    //                Debug.Log($"[{i}] index[{charInfo.index}] stringLength[{charInfo.stringLength}] char[{charInfo.character}]");
				//}
                ...
                Debug.Log($"stringPositionInternal[{stringPositionInternal},{stringSelectPositionInternal}] caretPositionInternal[{caretPositionInternal},{caretSelectPositionInternal}]");
        ...
        protected virtual void setupCaretCursorVertsColor()
        {
        ...
        public void DeactivateInputField(bool clearSelection = false)
        {
            ...
            {
               // Debug.Log($"DeactivateInputField:{m_WasCanceled},{m_RestoreOriginalTextOnEscape} originalText[{m_OriginalText}]");
