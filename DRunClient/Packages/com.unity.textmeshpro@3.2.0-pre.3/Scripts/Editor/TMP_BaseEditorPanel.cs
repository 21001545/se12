...
namespace TMPro.EditorUtilities
{
    public abstract class TMP_BaseEditorPanel : Editor
    {
        ...
        static readonly GUIContent k_EmojiSupportToggleLabel = new GUIContent("Emoji Support", "이모지 지원 여부");
        ...
        // FESTA-20 swpark, iOS 이모지 개발
        protected SerializedProperty m_IsEmojiSupportProp;
        ...
        protected virtual void OnEnable()
        {
            ...
            // FESTA-20 swpark, iOS 이모지 개발
            m_IsEmojiSupportProp = serializedObject.FindProperty("m_IsEmojiSupport");
        ...
        protected void DrawTextInput()
        {
            ...
            else
            {
                ...
                m_IsEmojiSupportProp.boolValue = EditorGUI.Toggle(new Rect(rect.width - 260, rect.y + 3, 110, 20), k_EmojiSupportToggleLabel, m_IsEmojiSupportProp.boolValue);
