...
public class LocationContentProvider extends ContentProvider {
    private static final String DB_NAME = "drun_location";
    //private static final String AUTHORITY = "com.lifefesta.drun.coreservice.store.location";
    ...
    public static final String COLUMN_H_ACCURACY = "h_accuracy";
    public static final String COLUMN_V_ACCURACY = "v_accuracy";
    ...
    private static final String DB_CREATE = "CREATE TABLE " + TABLE + "(" +
            ...
            COLUMN_H_ACCURACY + " REAL, " +
            COLUMN_V_ACCURACY + " REAL" +
            ");";
...
//            + AUTHORITY + "." + PATH;
    ...
    public boolean onCreate() {
        AUTHORITY = getContext().getPackageName() + ".coreservice.store.location";
